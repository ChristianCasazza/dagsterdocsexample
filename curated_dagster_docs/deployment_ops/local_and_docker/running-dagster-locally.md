...
`dagster dev` is intended for local development _only_. If you want to run Dagster for production use cases, see our other [deployment guides](https://docs.dagster.io/guides/deploy/deployment-options/).

## Locating your code [​](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally\#locating-your-code "Direct link to Locating your code")

Before starting local development, you need to tell Dagster how to find the Python code containing your assets and jobs.

For a refresher on how to set up a Dagster project, follow our [Recommended Dagster Project Structure](https://docs.dagster.io/guides/build/projects/structuring-your-dagster-project) guide.
...
code_location_name = "my_code_location"  ## optional
...
## Creating a persistent instance [​](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally\#creating-a-persistent-instance "Direct link to Creating a persistent instance")
...
## Configuring your instance [​](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally\#configuring-your-instance "Direct link to Configuring your instance")
...
For the full list of options that can be set in the `dagster.yaml` file, refer to the [Dagster instance documentation](https://docs.dagster.io/guides/deploy/dagster-instance-configuration).

## Detecting when you're running in `dagster dev` [​](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally\#detecting-when-youre-running-in-dagster-dev "Direct link to detecting-when-youre-running-in-dagster-dev")
...
## Moving to production [​](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally\#moving-to-production "Direct link to Moving to production")
...
For information about deploying Dagster in production, see the [Dagster Open Source deployment options documentation](https://docs.dagster.io/guides/deploy/deployment-options/).

- [Locating your code](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally#locating-your-code)
- [Creating a persistent instance](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally#creating-a-persistent-instance)
- [Configuring your instance](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally#configuring-your-instance)
- [Detecting when you're running in `dagster dev`](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally#detecting-when-youre-running-in-dagster-dev)
- [Moving to production](https://docs.dagster.io/guides/deploy/deployment-options/running-dagster-locally#moving-to-production)
