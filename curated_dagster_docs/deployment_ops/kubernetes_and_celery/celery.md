...
## Prerequisites [​](https://docs.dagster.io/guides/deploy/execution/celery\#prerequisites "Direct link to Prerequisites")
...
## Part 1: Write and execute a job [​](https://docs.dagster.io/guides/deploy/execution/celery\#part-1-write-and-execute-a-job "Direct link to Part 1: Write and execute a job")
...
Now you can execute the parallel job from the [Dagster UI](https://docs.dagster.io/guides/operate/webserver).

## Part 2: Ensuring workers are in sync [​](https://docs.dagster.io/guides/deploy/execution/celery\#part-2-ensuring-workers-are-in-sync "Direct link to Part 2: Ensuring workers are in sync")
...
### Step 1: Configure persistent run and event log storage [​](https://docs.dagster.io/guides/deploy/execution/celery\#step-1-configure-persistent-run-and-event-log-storage "Direct link to Step 1: Configure persistent run and event log storage")

First, configure appropriate persistent run and event log storage, e.g., `PostgresRunStorage` and `PostgresEventLogStorage` on your [Dagster instance](https://docs.dagster.io/guides/deploy/dagster-instance-configuration) (via [`dagster.yaml`](https://docs.dagster.io/guides/deploy/dagster-yaml)). This allows the webserver and workers to communicate information about the run and events with each other. Refer to the [Dagster storage section of the Dagster instance documentation](https://docs.dagster.io/guides/deploy/dagster-instance-configuration#dagster-storage) for information on how to do this.

note

The same instance config must be present in the webserver's environment and in the workers' environments. Refer to the [Dagster instance](https://docs.dagster.io/guides/deploy/dagster-instance-configuration) documentation for more information.

### Step 2: Configure a persistent I/O manager [​](https://docs.dagster.io/guides/deploy/execution/celery\#step-2-configure-a-persistent-io-manager "Direct link to Step 2: Configure a persistent I/O manager")
...
- [`s3.s3_pickle_io_manager`](https://docs.dagster.io/api/libraries/dagster-aws#dagster_aws.s3.s3_pickle_io_manager)
- [`adls2.adls2_pickle_io_manager`](https://docs.dagster.io/api/libraries/dagster-azure#dagster_azure.adls2.adls2_pickle_io_manager)
- [`gcs_pickle_io_manager`](https://docs.dagster.io/api/libraries/dagster-gcp#dagster_gcp.gcs_pickle_io_manager)

### Step 3: Supply executor and worker config [​](https://docs.dagster.io/guides/deploy/execution/celery\#step-3-supply-executor-and-worker-config "Direct link to Step 3: Supply executor and worker config")
...
### Step 4: Ensure Dagster code is accessible [​](https://docs.dagster.io/guides/deploy/execution/celery\#step-4-ensure-dagster-code-is-accessible "Direct link to Step 4: Ensure Dagster code is accessible")
...
The easiest way to do this is typically to package the code into a Python module and to configure your project's [`workspace.yaml`](https://docs.dagster.io/guides/deploy/code-locations/workspace-yaml) to have the webserver load from that module.
...
## Additional information [​](https://docs.dagster.io/guides/deploy/execution/celery\#additional-information "Direct link to Additional information")

### Using the dagster-celery CLI [​](https://docs.dagster.io/guides/deploy/execution/celery\#using-the-dagster-celery-cli "Direct link to Using the dagster-celery CLI")
...
If running Celery with custom config, include the config file path in these commands to ensure workers start with the correct config. Refer to [Step 3](https://docs.dagster.io/guides/deploy/execution/celery#step-3-supply-executor-and-worker-config) of the walkthrough for more information.
...
### Monitoring and debugging [​](https://docs.dagster.io/guides/deploy/execution/celery\#monitoring-and-debugging "Direct link to Monitoring and debugging")
...
### Broker and backend [​](https://docs.dagster.io/guides/deploy/execution/celery\#broker-and-backend "Direct link to Broker and backend")

`dagster-celery` has been tested using the RabbitMQ broker and default RPC backend.

- [Prerequisites](https://docs.dagster.io/guides/deploy/execution/celery#prerequisites)
- [Part 1: Write and execute a job](https://docs.dagster.io/guides/deploy/execution/celery#part-1-write-and-execute-a-job)
- [Part 2: Ensuring workers are in sync](https://docs.dagster.io/guides/deploy/execution/celery#part-2-ensuring-workers-are-in-sync)
  - [Step 1: Configure persistent run and event log storage](https://docs.dagster.io/guides/deploy/execution/celery#step-1-configure-persistent-run-and-event-log-storage)
  - [Step 2: Configure a persistent I/O manager](https://docs.dagster.io/guides/deploy/execution/celery#step-2-configure-a-persistent-io-manager)
  - [Step 3: Supply executor and worker config](https://docs.dagster.io/guides/deploy/execution/celery#step-3-supply-executor-and-worker-config)
  - [Step 4: Ensure Dagster code is accessible](https://docs.dagster.io/guides/deploy/execution/celery#step-4-ensure-dagster-code-is-accessible)
- [Additional information](https://docs.dagster.io/guides/deploy/execution/celery#additional-information)
  - [Using the dagster-celery CLI](https://docs.dagster.io/guides/deploy/execution/celery#using-the-dagster-celery-cli)
  - [Monitoring and debugging](https://docs.dagster.io/guides/deploy/execution/celery#monitoring-and-debugging)
  - [Broker and backend](https://docs.dagster.io/guides/deploy/execution/celery#broker-and-backend)
