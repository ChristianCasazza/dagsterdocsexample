...
## You will learn to: [​](https://docs.dagster.io/etl-pipeline-tutorial\#you-will-learn-to "Direct link to You will learn to:")
...
## Step 1: Set up your Dagster environment [​](https://docs.dagster.io/etl-pipeline-tutorial\#step-1-set-up-your-dagster-environment "Direct link to Step 1: Set up your Dagster environment")
...
## Step 2: Create the Dagster project structure [​](https://docs.dagster.io/etl-pipeline-tutorial\#step-2-create-the-dagster-project-structure "Direct link to Step 2: Create the Dagster project structure")
...
### Dagster project structure [​](https://docs.dagster.io/etl-pipeline-tutorial\#dagster-project-structure "Direct link to Dagster project structure")

#### dagster-etl-tutorial root directory [​](https://docs.dagster.io/etl-pipeline-tutorial\#dagster-etl-tutorial-root-directory "Direct link to dagster-etl-tutorial root directory")
...
#### etl\_tutorial directory [​](https://docs.dagster.io/etl-pipeline-tutorial\#etl_tutorial-directory "Direct link to etl_tutorial directory")
...
#### data directory [​](https://docs.dagster.io/etl-pipeline-tutorial\#data-directory "Direct link to data directory")
...
## Step 3: Launch the Dagster webserver [​](https://docs.dagster.io/etl-pipeline-tutorial\#step-3-launch-the-dagster-webserver "Direct link to Step 3: Launch the Dagster webserver")
...
## Next steps [​](https://docs.dagster.io/etl-pipeline-tutorial\#next-steps "Direct link to Next steps")
...
- [You will learn to:](https://docs.dagster.io/etl-pipeline-tutorial#you-will-learn-to)
- [Step 1: Set up your Dagster environment](https://docs.dagster.io/etl-pipeline-tutorial#step-1-set-up-your-dagster-environment)
- [Step 2: Create the Dagster project structure](https://docs.dagster.io/etl-pipeline-tutorial#step-2-create-the-dagster-project-structure)
  - [Dagster project structure](https://docs.dagster.io/etl-pipeline-tutorial#dagster-project-structure)
    - [dagster-etl-tutorial root directory](https://docs.dagster.io/etl-pipeline-tutorial#dagster-etl-tutorial-root-directory)
    - [etl\_tutorial directory](https://docs.dagster.io/etl-pipeline-tutorial#etl_tutorial-directory)
    - [data directory](https://docs.dagster.io/etl-pipeline-tutorial#data-directory)
- [Step 3: Launch the Dagster webserver](https://docs.dagster.io/etl-pipeline-tutorial#step-3-launch-the-dagster-webserver)
- [Next steps](https://docs.dagster.io/etl-pipeline-tutorial#next-steps)
